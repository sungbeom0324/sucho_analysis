                 ...
                 const char* goldenJsonFile = "")
{
    ...
    Float_t Z_mass_ee  = -1.0;
    Float_t Z_mass_eeg = -1.0;
    ...
    for (Long64_t i = 0; i < nAll; ++i) {
        ...
        // [S1] At least 2 opposite sign eletron.
        bool hasOS = false;
        ...
        // Find best pair of ee closest to Z_mass.
        int best_i = -1;
        int best_j = -1;
        ...
        z_ee = e1 + e2;
        Z_mass_ee  = z_ee.M();
        Z_mass_eeg = Z_mass_ee;  // If there is no photon, default.

        // [S5] Onshell Z window.
        if (Z_mass_ee < 80 || Z_mass_ee > 100) {
            continue;
        }
        ...
        // [S10] Control Region
        if (Z_mass_eeg > 120 && Z_mass_eeg < 130) {
            continue;
        }
